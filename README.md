...
This bash script will run the whole pipeline end-to-end, if you want a more detailed walkthrough of around the speedrun script see ["echovlm: Medical Imaging Report Generation Model for $5"](https://github.com/vukadinovic936/echovlm/discussions/1)
# Evaluation 
